...
class Aircraft(models.Model):
    ...
    seat_count_F = models.IntegerField(max_length=3, default=6, verbose_name="First Class Seats")
    seat_count_B = models.IntegerField(max_length=3, default=20, verbose_name="Business Class Seats")
    seat_count_E = models.IntegerField(max_length=3, default=60, verbose_name="Economy Class Seats")
